...
class Profile:
    ...
    You should make sure that your code verifies that required properties are
    set.
    ...
    get_posts returns the list object containing all posts that
    have been added to the Profile object
